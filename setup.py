...
DistUtilsExtra.auto.setup(
    ...
    data_files=[
        ('share/jockey', [
            'jockey/ui/gtk/jockey-gtk.ui']),
        # ('share/jockey', glob('jockey/ui/kde/*.ui')),
    ],
    scripts=[
        'jockey/ui/gtk/jockey-gtk',
        # 'jockey/ui/kde/jockey-kde',
        'jockey/ui/text/jockey-text',
        'jockey/ui/backend/jockey-backend',
        'jockey/ui/devmon/jockey-device-monitor',
    ],
)
